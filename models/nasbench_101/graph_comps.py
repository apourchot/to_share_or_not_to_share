...
from models.nasbench_101.base_ops import ConvBNRelu, MaxPool
...
class Graph(nn.Module):
    ...
    """
    def __init__(self, c_init, input_channels, n_classes, n_cells, n_stacks, n_nodes,
                 n_out_min, single_k, layers_params, **kwargs):
        ...
        for i in range(self.n_stacks):
            ...
            for j in range(self.n_cells):
                cell = CellCNN(self.n_nodes, self.n_out_min, self.c_in, self.c_out,
                               single_k=single_k, layers_params=layers_params)
