...
class ConvBNRelu(nn.Module):
    ...
    def __init__(self, c_in_max, c_out_max, kernel_size, stride, padding,
                 bn_momentum, bn_eps, conv_bias=False, affine_bn=True):

        super(ConvBNRelu, self).__init__()
        self.conv = VarConv2d(c_in_max, c_out_max, kernel_size, stride=stride,
                              padding=padding, bias=conv_bias)
        self.bn = VarBatchNorm2d(c_out_max, affine=affine_bn,
